...
<aside class="sidebar navbar-default" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="voiture.php"><i class="fa fa-chevron-right fa-fw"></i> Créer Voiture</a>
                <a href="employe.php"><i class="fa fa-chevron-right fa-fw"></i> Publier un Avis</a>
                <a href="contact.php"><i class="fa fa-chevron-right fa-fw"></i> Mes contact</a>
             </li>
        </ul>
    </div>
    <!-- /.sidebar-collapse -->
